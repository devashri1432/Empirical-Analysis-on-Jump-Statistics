...
# Function generating DGP-2
dgp_2 <- function(n, cluster_size, discard = 20) {
...
for (iteration in 1:num_iter) {
  ...
  data_matrix <- dgp_2(sample_size, cluster_size_sim2)

  # acf_features <- matrix(0, nrow = num_series, ncol = 5)
