...
# Function generating DGP-3
dgp_3 <- function(n, cluster_size, discard = 20) {
...
for (iteration in 1:num_iter) {
  ...
  data_matrix <- dgp_3(sample_size, cluster_size_sim3)
...
print("Empirical Probability for Simulation-3 Jump Statistic:")
